...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SettingsEtapeFoad.c2i'
        db.add_column(u'foad_settingsetapefoad', 'c2i',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SettingsEtapeFoad.c2i'
        db.delete_column(u'foad_settingsetapefoad', 'c2i')
