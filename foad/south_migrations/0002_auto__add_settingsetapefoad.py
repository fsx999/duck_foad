...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingsEtapeFoad'
        db.create_table(u'foad_settingsetapefoad', (
            (u'etape_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_apogee.Etape'], unique=True, primary_key=True)),
            ('date_fermeture', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_ouverture', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'foad', ['SettingsEtapeFoad'])


    def backwards(self, orm):
        # Deleting model 'SettingsEtapeFoad'
        db.delete_table(u'foad_settingsetapefoad')
