...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingsAnneeFoad'
        db.create_table(u'foad_settingsanneefoad', (
            ...
            ('annee_en_cour', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'foad', ['SettingsAnneeFoad'])


    def backwards(self, orm):
        # Deleting model 'SettingsAnneeFoad'
        db.delete_table(u'foad_settingsanneefoad')
