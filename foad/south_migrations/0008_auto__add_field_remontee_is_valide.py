...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Remontee.is_valide'
        db.add_column(u'foad_remontee', 'is_valide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Remontee.is_valide'
        db.delete_column(u'foad_remontee', 'is_valide')
    ...
    models = {
        ...
        u'foad.remontee': {
            ...
            'is_valide': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
