...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Remontee'
        db.create_table(u'foad_remontee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remontee', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('in_plateforme', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('etape', self.gf('django.db.models.fields.related.OneToOneField')(related_name='remontee', unique=True, to=orm['django_apogee.InsAdmEtp'])),
        ))
        db.send_create_signal(u'foad', ['Remontee'])


    def backwards(self, orm):
        # Deleting model 'Remontee'
        db.delete_table(u'foad_remontee')
